...
function PANEL:Init()
	...
	self:SetTextColor( Color( 140, 140, 140, 255 ) )
	self:SetFont( "anus_SmallText" )
...
function PANEL:Paint( w, h )
	...
	if self:GetDisabled() then
		draw.RoundedBox( 0, 0 + 1, 0 + 1, w - 2, h - 2, Color( 190, 190, 190, ANUS_MENUALPHA ) )
	else
		draw.RoundedBox( 0, 0 + 1, 0 + 1, w - 2, h - 2, Color( 240, 240, 240, ANUS_MENUALPHA ) )
	end
